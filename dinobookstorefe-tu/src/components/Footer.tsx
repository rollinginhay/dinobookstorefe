      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm mb-4 text-gray-400">
              Cửa hàng sách trực tuyến hàng đầu với hàng ngàn cuốn sách được chọn lọc kỹ lưỡng từ trong nước và quốc tế.
            </p>
          ...
          {/* Customer Service */}
          <div>
            <h3 className="text-white font-bold text-lg mb-4">Chăm sóc khách hàng</h3>
            <ul className="space-y-3 text-sm">
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm">
            <p className="mb-4 md:mb-0">&copy; 2024 Dino Bookstore. Tất cả quyền được bảo lưu.</p>
            <div className="flex gap-6">
              ...
              <Link href="/quy-dinh" className="hover:text-white transition-colors">Quy định</Link>
            </div>
          </div>
        </div>
      </div>
