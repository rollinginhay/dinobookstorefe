...
export default function PropertyFilterDropdown({selectedCategory, categories, onCategoryChange}) {
    const [selected, setSelected] = useState(categories.filter(e => e.value === selectedCategory)[0]);
    ...
    return (
        <div className="relative inline-block text-left">
          ...
          ▼
            ...
            {open && (
                <div
                    className="absolute z-10 mt-2 w-44 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ri
                    ng-opacity-5">
                    <div className="py-1">
